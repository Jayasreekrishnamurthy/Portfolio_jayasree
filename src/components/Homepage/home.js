...
import headerImg from "../../assets/bgimg.jpg";
...
// import Certificate from "../certificationpage/certificate"
import Footer from "../Footer/footer"
import {Projects} from "../certificationpage/Projects"
            ...
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Web Developer", "Web Designer", "UI/UX Designer" ]'><span className="wrap">{text}</span></span>
                  <p>Full Stack Developer with 1+ years of hands-on experience designing, developing, 
                    ...
                    expertise in a challenging role as a Full Stack Developer.</p>
            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__zoomIn" : ""}>
                  <img className="sideimg" src={headerImg} alt="Header Img"/>
                </div>}
            </TrackVisibility>
          </Col>
        </Row>
